...
<div class="wrap">
  <div class="row-fluid">
    ...
    <img class="img-polaroid" src="http://placehold.it/330x200" />
    <h2>Optimist</h2>
    <p>Words on how I view the world, my philiosphies, and why I get out of bed in the morning. Basically what I care about most.</p>
    </div>
    <div class="span4">
    <img class="img-polaroid" src="http://placehold.it/330x200" />
    <h2>Designer</h2>
...
<div class="media">
  ...
  <div class="media-body">
    ...
    <p>Stuff about my Career, goals, links to MaskellMedia, and a breif overview of my accomplishments and current status.</p>
  </div>
</div>
  </div>
</div>
...
<footer>
  ...
  <h3 class="full-header">Lets Socialize</h3>
